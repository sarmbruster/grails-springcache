...
class WebContentKeyGenerator extends DefaultKeyGenerator {
	...
	@Override protected void generateKeyInternal(CacheKeyBuilder builder, ContentCacheParameters context) {
		...
		if (format) handleFormat(builder, context)
		if (method) handleMethod(builder, context)
	}
	...
	void handleFormat(CacheKeyBuilder builder, ContentCacheParameters context) {
	...
	void handleMethod(CacheKeyBuilder builder, ContentCacheParameters context) {
